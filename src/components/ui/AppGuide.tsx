...
const PAGE_CHIPS: Record<string, string[]> = {
  '/':                 ['Что такое BeautyOS?', 'Как начать работу?', 'Для кого это приложение?', 'Это бесплатно?'],
  '/explain':          ['Я мастер, с чего начать?', 'Я клиент, что делать?', 'Чем отличаются роли?'],
  '/pricing':          ['Сколько стоит?', 'Есть ли бесплатный период?', 'Как оплатить?'],
